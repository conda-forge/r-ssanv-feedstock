...
[![Linux](https://img.shields.io/circleci/project/github/conda-forge/r-ssanv-feedstock/master.svg?label=Linux)](https://circleci.com/gh/conda-forge/r-ssanv-feedstock)
[![OSX](https://img.shields.io/travis/conda-forge/r-ssanv-feedstock/master.svg?label=macOS)](https://travis-ci.org/conda-forge/r-ssanv-feedstock)
[![Windows](https://img.shields.io/appveyor/ci/conda-forge/r-ssanv-feedstock/master.svg?label=Windows)](https://ci.appveyor.com/project/conda-forge/r-ssanv-feedstock/branch/master)
...
Once the `conda-forge` channel has been enabled, `r-ssanv` can be installed with:

```
conda install r-ssanv
```

It is possible to list all of the versions of `r-ssanv` available on your platform with:
